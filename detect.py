...
def run(
        weights=ROOT / 'best_cell_count.pt',  # model path or triton URL
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'best_cell_count.pt', help='model path or triton URL')
